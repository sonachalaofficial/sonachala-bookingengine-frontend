...
function HomePage() {
  ...
  useEffect(() => {
    ...
    setBookingLocation(
      urlLocation || localStorage.getItem("location") || "Tiruvannamalai"
    );
    setAdults(
      Number.parseInt(urlAdults) ||
        Number.parseInt(localStorage.getItem("adults")) ||
        1
    );
    setChildren(
      Number.parseInt(urlChildren) ||
        Number.parseInt(localStorage.getItem("children")) ||
        0
    );
    setRooms(
      Number.parseInt(urlRooms) ||
        Number.parseInt(localStorage.getItem("rooms")) ||
        1
    );
    ...
    localStorage.setItem(
      "adults",
      urlAdults || localStorage.getItem("adults") || "1"
    );
    localStorage.setItem(
      "children",
      urlChildren || localStorage.getItem("children") || "0"
    );
    localStorage.setItem(
      "rooms",
      urlRooms || localStorage.getItem("rooms") || "1"
    );
        ...
        >
          <div className="container py-5">
            <h1 className="display-5 fw-bold text-light">
              {/* Pack the whole toybox */}
            </h1>
            <p className="col-md-8 fs-4 text-light">
              {/* Unwind and stretch out in a vacation home */}
            </p>
            {/* <button
                        ...
                        <div className="form-group">
                          ...
                          <div className="input-group">
                            ...
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                incrementValue(setAdults, adults, 30)
                              }
                              style={{
                                backgroundColor:
                                  adults < 30 ? "#038A5E" : "gray",
                                color: "white",
                              }}
                              disabled={adults >= 30}
                            >
                        ...
                        <div className="form-group">
                          ...
                          <div className="input-group">
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                decrementValue(setChildren, children, 0)
                              }
                              style={{
                                backgroundColor:
                                  children > 0 ? "#038A5E" : "gray",
                                color: "white",
                              }}
                              disabled={children <= 0}
                            >
                            ...
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                incrementValue(setChildren, children, 10)
                              }
                              style={{
                                backgroundColor:
                                  children < 10 ? "#038A5E" : "gray",
                                color: "white",
                              }}
                        ...
                        <div className="form-group">
                          ...
                          <div className="input-group">
                            <button
                              ...
                              style={{
                                backgroundColor: rooms > 1 ? "#038A5E" : "gray",
                                color: "white",
                              }}
                              disabled={rooms <= 1}
                            >
                  ...
                  <div className="col-md-9">
                    <div className="card-body">
                      <h5 className="card-title">
                        3 Days & 2 Nights Accordable Stay Price
                      </h5>
          ...
          <div className="row g-4">
              ...
              >
                ...
                >
                  <h5 className="text-white m-0">
                    Near Arunachaleswarar Temple Stays
                  </h5>
                </div>
              </div>
            </div>
            <div className="col-md-6">
              ...
              >
                ...
                >
                  <h5 className="text-white m-0">
                    Budget Stays in Tiruvannamalai
                  </h5>
                </div>
              </div>
            </div>
        ...
        <div className=" my-5">
                  ...
                  <div className="col p-3">
                    <div className="card" style={{ border: "none" }}>
                      <img
                        ...
                        alt="Apartments"
                      />
                      <h5 className="card-title text-center p-1">
                        Sri Ramana Ashram
                      </h5>
                    </div>
                  </div>
          ...
          <div className="container">
            ...
            <div className="container my-5">
              <div
                className="text-center d-flex overflow-auto pb-3"
                style={{ gap: "20px", whiteSpace: "nowrap" }}
              >
                {[
                  {
                    name: "MPS Saai Residency",
                    address: "61-B ROA Nagar, Chengam Road, Ramana nagar",
                    img: "./assets/index/bestWeekend 1.png",
                    rating: "4.6",
                    oldPrice: "5,999",
                    newPrice: "4,271",
                    taxes: "513",
                  },
                  {
                    ...
                    img: "./assets/index/bestWeekend 2.png",
                    rating: "4.3",
                    oldPrice: "4,999",
                    newPrice: "3,999",
                    taxes: "450",
                  ...
                  },
                  {
                    ...
                    address: "Kodaikanal Main Road",
                    img: "./assets/index/bestWeekend 3.png",
                    rating: "4.7",
                    oldPrice: "6,499",
                    newPrice: "4,999",
                    taxes: "550",
          ...
          >
            <div className="row align-items-center">
              ...
              <div className="col-md-6 text-center text-md-start px-5">
                ...
                <button
                  className="btn btn-lg fw-bold mt-3 rounded-pill"
          ...
          <div className="container my-5">
            <div className="row justify-content-center align-items-stretch">
              <div className="col-12 col-lg-3 col-md-6 pb-4">
                <div
                  style={{ border: "2px solid #038A5E" }}
                  className="card text-center align-items-stretch"
                >
                  <img
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      24/7 Availability Booking apps allow users to make
                      reservations or appointments at any time, without being
              ...
              <div className="col-12 col-lg-3 col-md-6 pb-4">
                ...
                >
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Instant Confirmation Many booking websites provide instant
                      confirmation of bookings, reducing uncertainty and the
              ...
              <div className="col-12 col-lg-3 col-md-6 pb-4">
                ...
                >
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      User Reviews Access to reviews and ratings from other
                      customers provides insights into the quality and service
                      of accommodations and travel services.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-12 col-lg-3 col-md-6 pb-4">
                ...
                >
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Intuitive platforms that simplify the booking process,
                      often with step-by-step guidance.
                    </p>
                  </div>
                </div>
              </div>
